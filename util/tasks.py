...
class Task:
    ...
    def __init__(self, columns, encoder_dimension=128, decoder_dimension=128,
                 output_dimension=128, task_name='ev'):
        """
...
class BatterybrandmileageTask(Task):
    def set_params(self):
        self.encoder_dimension = 8
        self.decoder_dimension = 2
...
def to_tensor(input_embedding):
    return torch.from_numpy(np.array(input_embedding)).cuda()
