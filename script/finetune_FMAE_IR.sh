...
htail="${mask_type}"
downstream="IR"
log_dir="logs/IR/${htail}/${ckpt}_pretrain_${modelname}/epoch${epoch}_warmupepoch${warmupepoch}_blr${blr}_bsz${batchsize}_ld${layerdecay}_wd${weightdecay}_dp${droppath}/s${seed}"
